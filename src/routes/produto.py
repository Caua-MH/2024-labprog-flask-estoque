...
def novo():
    if Categoria.is_empty():
        flash("Indisponivel adicionar produto. Adicione pelo menos uma categoria",
              category='warning')
